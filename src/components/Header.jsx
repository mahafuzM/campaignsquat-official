...
const Header = () => {
  ...
  const [content, setContent] = useState({
    ...
    paragraph:
      "From UI/UX Design that captivates users to full-cycle Website Design & Development using MERN Stack, PHP, and Laravel, Campaignsquat Ltd delivers high-performance solutions.",
    vimeoId: "1153559168",
    imageUrl: "",
  });
  ...
  return (
    <section className="relative w-full bg-[#02050A] pt-2 md:pt-6 lg:pt-8 font-poppins overflow-hidden perspective-container">
      ...
      <div className="max-w-[1440px] mx-auto px-4 xl:px-10 flex flex-col items-center text-center relative z-10">
            ...
            <div className="flex flex-col items-center gap-3">
              <div className="flex -space-x-3 items-center mb-1">
                ...
                <div className="w-9 h-9 md:w-11 md:h-11 rounded-full bg-[#162E44] flex items-center justify-center shadow-lg z-[1] border border-white/10">
                  <span className="text-white font-black text-[10px] md:text-[12px]">
                    GF
                  </span>
                </div>
              </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-1">
                    {[...Array(5)].map((_, i) => (
                      <svg
                        key={i}
                        className="w-5 h-5 md:w-6 md:h-6 text-[#F7A400]"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 md:gap-8 max-w-[1200px] px-4">
              ...
              <div className="relative group transition-all duration-300 hover:-translate-y-1">
                <div className="w-16 h-18 md:w-24 md:h-26 bg-white/5 backdrop-blur-sm flex items-center justify-center hex-shape border-2 border-white/20 hover:border-white">
                  ...
                  >
                    <path
                      d="M149.508 157.52L69.142 54.2027H53.0034V125.797H64.7334V74.1437L134.195 163.784C139.367 161.947 144.57 159.845 149.508 157.52Z"
                      fill="white"
                    />
                    <path
                      d="M109.43 54.2027H97.7V125.797H109.43V54.2027Z"
                      fill="white"
                    />
                  </svg>
                </div>
              ...
              <div className="relative group transition-all duration-300 hover:-translate-y-1">
                <div className="w-16 h-18 md:w-24 md:h-26 bg-white/5 backdrop-blur-sm flex items-center justify-center hex-shape border-2 border-white/20 hover:border-[#F24E1E]">
                  ...
                  >
                    ...
                    />
                    <path
                      d="M19 38H9.5C4.25 38 0 42.25 0 47.5C0 52.75 4.25 57 9.5 57H19V38Z"
                      fill="#1ABCFE"
                    />
                    <path
                      d="M38 19H28.5C23.25 19 19 23.25 19 28.5V38H28.5C33.75 38 38 33.75 38 28.5C38 23.25 33.75 19 28.5 19Z"
                      fill="#0ACF83"
                    />
                    <path
                      d="M38 0H28.5C23.25 0 19 4.25 19 9.5V19H28.5C33.75 19 38 14.75 38 9.5C38 4.25 33.75 0 28.5 0Z"
                      fill="#FF7262"
                    />
                  </svg>
                </div>
              ...
              <div className="relative group transition-all duration-300 hover:-translate-y-1">
                <div className="w-16 h-18 md:w-24 md:h-26 bg-[#FF2D20]/10 backdrop-blur-sm flex items-center justify-center hex-shape border-2 border-[#FF2D20]/30 hover:border-[#FF2D20]">
                  <svg className="w-8 h-8 md:w-12 md:h-12" viewBox="0 0 24 24">
                    <path
                      d="M20.042 17.143l-8.042 4.607l-8.042-4.607v-9.286l8.042-4.607l8.042 4.607v9.286zm-1.005-8.106l-7.037-4.032l-7.037 4.032v8.106l7.037 4.032l7.037-4.032v-8.106z"
                      fill="#FF2D20"
                    />
                  </svg>
                </div>
              ...
              <div className="relative group transition-all duration-300 hover:-translate-y-1">
                <div className="w-16 h-18 md:w-24 md:h-26 bg-[#68A063]/10 backdrop-blur-sm flex items-center justify-center hex-shape border-2 border-[#68A063]/30 hover:border-[#68A063]">
                  <svg
                    ...
                    fill="none"
                  >
                    <path d="M128 20L40 70v100l88 50" fill="#3E863D" />
                    <path d="M128 20l88 50v100l-88 50" fill="#61a05e" />
                    <path
                      d="M128 120L40 70l88-50 88 50-88 50z"
                      fill="#83CD29"
                    />
                    <path d="M128 220V120L40 70v100l88 50z" fill="#3E863D" />
                    <path d="M128 220V120l88-50v100l-88 50z" fill="#4CAF50" />
                  </svg>
                </div>
              </div>
            </div>
        ...
        {/* Paragraph */}
        <div
          className="w-full px-2 max-w-[1100px] mx-auto mb-6 md:mb-12 fade-in-up"
        ...
        {/* Button */}
        <div
          className="mb-12 md:mb-24 flex justify-center fade-in-up"
        ...
        <div
          className="w-full pb-20 fade-in-up"
        ...
        >
          <div className="running-border-container shadow-2xl rounded-xl overflow-hidden relative">
            ...
            <div
              className="inner-content relative group cursor-pointer"
          ...
          <div className="fixed inset-0 w-screen h-screen z-[9999999] flex items-center justify-center bg-black/95 backdrop-blur-md p-4 overflow-hidden">
            <div className="relative w-full max-w-7xl aspect-video">
              <button
                ...
                className="absolute -top-14 right-0 text-white hover:text-[#f7a400] transition-all p-2 z-[10000000] hover:scale-110"
              >
