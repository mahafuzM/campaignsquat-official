    ...
    return (
      <div className="min-h-screen bg-[#02050A] text-white flex items-center justify-center font-['Poppins']">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="animate-pulse text-[#F7A400] text-lg tracking-[0.3em] uppercase font-bold">
    ...
    return (
      <div className="min-h-screen bg-[#02050A] text-white flex flex-col items-center justify-center font-['Poppins'] p-6 text-center">
        ...
        <button
          ...
          className="bg-[#F7A400] text-black px-8 py-3 rounded-[5px] font-bold mt-6 hover:bg-white transition-all"
        >
          Return to Portfolio
        </button>
      </div>
        ...
        <div className="absolute bottom-4 md:bottom-16 left-0 right-0 z-10">
          <div className="max-w-[1445px] mx-auto px-6 md:px-10 lg:px-16 w-full">
            ...
            >
              ...
              <span className="text-[10px] md:text-[14px] font-semibold text-white ">
                Go Back
              </span>
            </button>
      ...
      <div className="max-w-[1445px] mx-auto px-6 md:px-10 lg:px-16 w-full">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 bg-[#0A0A0A] border border-gray-900 p-5 md:p-8 rounded-[5px] shadow-2xl backdrop-blur-3xl w-full">
            ...
            <div className="space-y-2">
              <p className="text-white text-[12px] md:text-[16px] font-semibold flex items-center gap-2">
                <User className="text-[#F7A400] w-5 h-5 md:w-[22px] md:h-[22px] flex-shrink-0" />{" "}
                Client
              </p>
            ...
            <div className="space-y-2">
              <p className="text-white text-[12px] md:text-[16px] font-semibold flex items-center gap-2">
                <Calendar className="text-[#F7A400] w-5 h-5 md:w-[22px] md:h-[22px] flex-shrink-0" />{" "}
                Launch
              </p>
            ...
            <div className="space-y-2">
              <p className="text-white text-[12px] md:text-[16px] font-semibold flex items-center gap-2">
                <Tag className="text-[#F7A400] w-5 h-5 md:w-[22px] md:h-[22px] flex-shrink-0" />{" "}
                Industry
              </p>
              <p className="text-[10px] md:text-[14px] font-semibold truncate">
            ...
            <div className="space-y-2">
              <p className="text-white text-[12px] md:text-[16px] font-semibold flex items-center gap-2">
                <Globe className="text-[#F7A400] w-5 h-5 md:w-[22px] md:h-[22px] flex-shrink-0" />{" "}
                Preview
              </p>
              {project.projectUrl ? (
                <a
        ...
        <section className="mt-16 md:mt-24 space-y-16 md:space-y-20 w-full">
          {project.sections?.map((section, idx) => (
            <div
              key={idx}
              className="animate-in fade-in slide-in-from-bottom-10 duration-1000 w-full"
            >
        ...
        <section className="mt-12 md:mt-30 pb-10 flex flex-col items-center text-center px-2">
          ...
          <h3 className="text-[26px] md:text-[30px] font-semibold mb-6 tracking-tighter leading-tight">
            Ready to scale with{" "}
            <span className="text-[#F7A400]">Campaignsquat Ltd?</span>
          </h3>

          <p className="text-white max-w-7xl mb-10 text-[16px] md:text-[20px] leading-relaxed">
            From "pixel-perfect" interfaces to high-performance engineering, we
            don't just build websites—we build digital legacies. Let’s
            collaborate to turn your vision into a market-leading product.
          </p>
