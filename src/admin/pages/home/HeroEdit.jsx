      ...
      <div className="w-full px-6 md:px-12 py-10">
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-12">
            ...
            <div className="p-8">
              <div className="flex items-center justify-between mb-6">
                ...
                <p className="text-xs font-medium text-gray-400">
                  {availableIcons.length} icons stored
                </p>
              </div>
                ...
                {availableIcons.length > 0 ? (
                  availableIcons.map((icon) => (
                    <div
                      key={icon._id}
                      onClick={() =>
                        setContent({ ...content, badge: icon.name })
                      }
                    ...
                    >
                      ...
                      <span
                        className={`text-[13px] font-bold capitalize tracking-tight transition-colors ${content.badge === icon.name ? "text-[#F7A400]" : "text-black"}`}
                      >
                        {icon.name}
                      </span>
                  ...
                  <div className="col-span-full py-16 flex flex-col items-center justify-center bg-gray-50 rounded-[5px] border-2 border-dashed border-gray-200">
                    <p className="text-gray-400 font-medium">
                      No assets found. Start building your library!
                    </p>
                  </div>
                )}
              </div>
          ...
          <div className="flex flex-col gap-4">
            <label className="font-semibold text-[14px] text-black uppercase tracking-wider">
              Main Heading
            </label>
            <textarea
              rows="2"
              ...
              {previewUrl && (
                <div className="mt-6">
                  <img
                    src={previewUrl}
                    alt="Preview"
                    className="w-full h-[400px] object-cover rounded-2xl border-2 border-gray-100 shadow-xl"
                  />
                </div>
              )}
            </div>
