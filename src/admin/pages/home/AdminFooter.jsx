        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-gray-900">
              Footer <span className="text-[#F7A400]">Panel</span>
            </h1>
            <p className="text-gray-500 text-sm mt-1">
              Manage your website's bottom architecture and contact info.
            </p>
          </div>
          <button
            onClick={handleSave}
            ...
            <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-sm">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-lg font-bold flex items-center gap-2 text-gray-800">
                  <Share2 size={20} className="text-[#F7A400]" /> Social
                  Presence
                </h2>
                <button
                  onClick={() => addArrayItem("socialLinks")}
                  className="text-[#F7A400] hover:bg-orange-50 p-2 rounded-full transition-colors"
                >
                  <Plus size={20} />
                </button>
              </div>
              <div className="space-y-3">
                {footerData.socialLinks.map((social, idx) => (
                  <div
                    key={idx}
                    className="flex gap-3 items-center bg-gray-50 p-3 rounded-lg border border-gray-100"
                  >
                    <input
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-gray-50 border border-gray-200 rounded-lg p-3 pl-10 focus:border-[#F7A400] outline-none shadow-inner text-sm"
                  />
                </div>
              </div>
              <div>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center border-t pt-6">
                ...
                <button
                  ...
                  className="text-xs bg-black text-white px-3 py-1.5 rounded-md flex items-center gap-1 hover:bg-[#F7A400] transition-colors shadow-sm"
                >
              ...
              {footerData.contact.offices.map((office, idx) => (
                <div
                  key={idx}
                  className="flex gap-4 items-start bg-gray-50 p-4 rounded-xl border border-gray-200 relative group"
                >
                  <div className="flex-1 space-y-3">
                    ...
                    <textarea
                      ...
                      className="w-full bg-transparent border-b border-gray-300 p-1 text-sm outline-none focus:border-[#F7A400]"
                      rows="2"
                    ></textarea>
                  </div>
                  <button
            ...
            <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-sm">
              ...
              <div className="space-y-3">
                {footerData.services.map((service, idx) => (
                  <div
                    key={idx}
                    className="flex flex-col gap-2 bg-gray-50 p-4 rounded-lg border border-gray-100 group"
                  >
                    ...
                    <input
                      placeholder="Path (e.g. /service/web)"
                      value={service.link}
                      onChange={(e) => {
                        const newServices = [...footerData.services];
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFooterData({
                      ...footerData,
                      hiringStatus: {
                        ...footerData.hiringStatus,
                        showCard: e.target.checked,
                      },
                    })
                  }
                  className="accent-[#F7A400] w-5 h-5"
                />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="md:col-span-1">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-lg p-3 text-white outline-none focus:border-[#F7A400]"
                />
              </div>
              <div className="md:col-span-1">
                <label className="text-[10px] uppercase tracking-widest text-gray-500 mb-2 block">
