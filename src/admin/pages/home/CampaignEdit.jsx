    ...
    <div className="p-4 md:p-8 bg-gray-50 min-h-screen font-poppins">
      <div className="max-w-4xl mx-auto bg-white rounded-[5px] shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="bg-[#050910] p-6 text-white">
          ...
          <p className="text-white text-[10px] mt-1  tracking-widest">
        ...
        <form onSubmit={handleSubmit} className="p-6 md:p-10 space-y-8">
          ...
          {message.text && (
            <div
              className={`p-4 rounded-[5px] flex items-center gap-3 ${message.type === "success" ? "bg-green-50 text-green-700 border border-green-200" : "bg-red-50 text-red-700 border border-red-200"}`}
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="space-y-6">
              <div>
                <label className="block text-[12px] font-bold text-black mb-2">
                  Main Title
                </label>
                <input
                  type="text"
                ...
                <p className="text-[10px] text-black mt-1 italic">
                  * Use HTML tags if needed for styling.
                </p>
              </div>
            ...
            <div className="space-y-6">
                ...
                {preview ? (
                  <div className="relative w-full h-full">
                    <img
                      src={preview}
                      alt="Preview"
                      className="w-full h-48 object-cover rounded-[5px] shadow-md"
                    />
              ...
              <p className="text-[10px] text-black text-center">
                Recommended size: 800x1000px (WebP format preferred)
              </p>
            </div>
          </div>
