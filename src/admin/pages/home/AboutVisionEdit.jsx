  ...
  return (
    <div className="p-4 md:p-10 bg-white min-h-screen text-black font-poppins w-full">
      ...
      >
        <div className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-gray-50 border p-3 rounded-[5px]"
            />
            {imagePreview && (
              <img
                src={imagePreview}
                className="mt-4 w-full h-48 object-cover rounded-[5px]"
                alt="preview"
              />
            )}
          </div>
        ...
        <button
          type="submit"
          className="bg-black text-white px-10 py-4 rounded-[5px] font-bold md:col-span-2"
        >
