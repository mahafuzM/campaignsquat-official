...
const ProductManager = () => {
  ...
  const addSection = (type) => {
    const newSection =
      type === "list" ? { type, value: "", items: [""] } : { type, value: "" };
        ...
        >
            ...
            <div className="bg-gray-50 p-6 rounded-[5px] border border-gray-200 shadow-sm">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full p-3 bg-white border border-gray-300 rounded-[5px] outline-none"
                    value={formData.name}
                    onChange={(e) =>
                ...
                <div>
                  ...
                  <textarea
                    className="w-full p-3 bg-white border border-gray-300 rounded-[5px] h-24 outline-none"
                ...
                <div>
                  ...
                  <input
                    type="file"
                    className="w-full p-2 border border-gray-300 rounded-[5px] bg-white"
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      type="text"
                      placeholder="Buy Now"
                      className="w-full p-2 bg-white border rounded-[5px] text-sm outline-none"
              ...
              {isEditing && (
                <button
                  type="button"
                  onClick={resetForm}
                  className="mt-6 w-full py-2 text-sm font-bold text-red-500 border border-red-200 rounded-[5px] hover:bg-red-50 transition-all"
                >
                  Cancel Editing
                </button>
              )}
          ...
          <div className="w-full lg:w-2/3 bg-white p-8 lg:p-12 border border-gray-100 rounded-[5px] shadow-sm space-y-8 min-h-[600px] relative">
            <div className="flex items-center justify-between mb-6">
              ...
              <button
                type="submit"
                className="hidden lg:flex items-center gap-2 bg-[#F7A400] text-white px-8 py-3 rounded-full font-bold hover:shadow-lg transition-all active:scale-95"
              >
                <Save size={18} />{" "}
                {isEditing ? "Update Changes" : "Publish Post"}
              </button>
            </div>
            ...
            <div className="space-y-10 pb-24">
              ...
              {sections.map((section, sIndex) => (
                <div
                  key={sIndex}
                  className="relative bg-gray-50 p-6 rounded-[5px] border border-gray-100 group"
                >
                  <button
                    type="button"
            ...
            <div className="sticky bottom-8 bg-white/80 backdrop-blur-md border border-gray-200 p-4 rounded-[5px] shadow-2xl flex items-center justify-between z-10">
              <div className="flex gap-4">
                <button
                  ...
                  className="px-4 py-2 hover:bg-gray-100 rounded-[5px] text-gray-600 text-sm font-bold"
                >
                  H1 Heading
                </button>
                <button
              ...
              <button
                type="submit"
                className="lg:hidden bg-[#F7A400] text-white px-6 py-2 rounded-full font-bold"
              >
